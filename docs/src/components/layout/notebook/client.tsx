...
export function NavbarLinkItem({
  ...
  return (
    <LinkItem
      item={item}
      className={cn(
        'inline-flex items-center gap-2 text-sm text-fd-muted-foreground transition-colors hover:text-fd-accent-foreground data-[active=true]:text-fd-primary [&_svg]:size-4',
        className,
      )}
      {...props}
    >
