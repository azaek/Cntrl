  ...
  return new ImageResponse(
    ...
    >
      ...
      <h1 style={{ fontSize: "4rem" }}>
        Docs/{page.data.title}
      </h1>
      <p style={{ fontSize: "1.4rem", marginTop: "-16px", fontFamily: "Geist", fontWeight: "400" }}>{page.data.description}</p>
    </div>,
    {
      width: 1200,
      height: 630,
